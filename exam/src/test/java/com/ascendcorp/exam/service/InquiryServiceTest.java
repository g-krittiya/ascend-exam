...
public class InquiryServiceTest {
    ...
    public void initData() {
        List<ResponseMapping> responseMappings = new ArrayList<>();
        ...
        when(responseMappingRepository.getAllResponseMapping()).thenReturn(responseMappings);
    }
    ...
    public void should_return500_when_noRequireValue() throws SQLException {
        ...
        // Transaction Id
        // InquiryRequest x=new InquiryRequest();

        InquiryServiceResultDTO inquiry = inquiryService.inquiry(new InquiryRequest(null, new Date(),
                "Mobile", null,
        ...
        // Datetime
        inquiry = inquiryService.inquiry(new InquiryRequest("1234", null,
                "Mobile", null,
                "BANK1", "4321000", 100d, "rrivsffv234c",
                "11223xfgt", null, null));
        ...
        // Channel
        inquiry = inquiryService.inquiry(new InquiryRequest("1234", new Date(),
                null, null,
                "BANK1", "4321000", 100d, "rrivsffv234c",
                "11223xfgt", null, null));
    ...
    public void should_return200_when_bankApproved() throws SQLException {
        ...
        when(bankProxyGateway.requestTransfer(any())).thenReturn(transferResponse);

        InquiryServiceResultDTO inquiry = inquiryService.inquiry(new InquiryRequest("123456", new Date(),
                "Mobile", null,
                "BANK1", "4321000", 100d, "rrivsffv234c",
                "11223xfgt", null, null));
    ...
    public void should_return504_when_responseNull() throws SQLException {
        ...
        when(bankProxyGateway.requestTransfer(any())).thenReturn(null);
    ...
    public void should_return503_when_throwWebServiceException() throws SQLException {
        ...
        when(bankProxyGateway.requestTransfer(any())).thenThrow(WebServerException.class);
    ...
    public void should_return503_when_socketTimeout() throws SQLException {
        ...
        when(bankProxyGateway.requestTransfer(any())).thenThrow(ex);
    ...
    @Test
    public void should_return504_when_throwException_notFoundResponseMap() throws SQLException {
        TransferResponse transferResponse = new TransferResponse();
        transferResponse.setResponseCode("unknown");
        transferResponse.setDescription("this error not found in db config");
